<?php
	...
	if(isset($_POST['cadastrar'])){
		...
		$resposta = $produto->insereCrud($array_dados); #colocando $resposta e o if ele não renvia o mesmo produto novamente para o banco de dados.
		if ($resposta)
		header("Location: index.php?cadastrar=sucesso");
		else
		header("Location: index.php?castrar=erro");
	}
?>
	...
	<div class="container">
		...
		<tbody>
			<?php
				...
				foreach($resposta as $indce => $valor){
				echo'<tr>';
